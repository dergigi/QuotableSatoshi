...
[![Follow @QuotableSatoshi on twitter](https://img.shields.io/badge/@QuotableSatoshi-blue.svg?style=social&logo=twitter)](https://twitter.com/QuotableSatoshi)
...
Feel free to follow [the bot](https://twitter.com/QuotableSatoshi) on twitter. Quotes are posted as single tweets every 12 hours. The bot will not post anything else.

Some quotes are too long to fit a single tweet. If that is the case, sentences will be omitted until the quote is below 280 characters. The following quote
